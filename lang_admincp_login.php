...
(
	...
	'login_cplock'		=> 'Your Yönetici Paneli has been locked!<br>Please re-visit later in <b>{ltime}</b> seconds',//'您的管理面板已经锁定!<br>请在 <b>{ltime}</b>秒以后重新访问管理中心',
	...
	'login_cp_noaccess'	=> '<b>Yönetici Paneli (or this operation) was not yet opened for you.</b><br><br>Your current operation has been recorded, do not try illegall actions.',//'<b>管理中心(或此项操作)尚未对您开放</b><br><br>您的此次操作已经记录, 请勿非法尝试',

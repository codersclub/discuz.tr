...
$lang = array (
	...
	'replacekey_must_write_config'		=> 'config_global.php is not writable, this operation cannot be performed',
	'replacekey_succeed'			=> 'The key is updated successfully, please log in to the site again and update the cache',
	...
	'database_export_multivol_succeed'	=> 'Congratulations, {volume} backup files have been created successfully, and the backup is all completed.<br /><br /><font color="red">For security reasons, we strongly recommend that you download the database backup file and then delete the file or make the file inaccessible via URL.</font><br /><br />{filelist}{deletetips}',
	'database_export_zip_succeed'		=> 'The data is successfully backed up and compressed to the server <a href="{filename}">{filename}</a><br /><br /><font color="red">For safety Consider, we strongly recommend that you download the database backup file after deleting the file or setting the file to be inaccessible via URL.</font>{deletetips}',
	...
	'templates_edit_identifier_invalid'	=> 'The unique identifier you entered is invalid or duplicates an existing template',
	'templates_add_succeed'			=> 'The template has been successfully added. Please continue to complete the template development',
	'plugin_not_found'			=> 'Plugin not found',//'插件未找到',
	'plugins_install_succeed'		=> 'The plug-in is successfully installed!<br />In order to use this plug-in normally, you may also need to upload or modify the corresponding file or template. For details, please see the installation instructions of this plug-in<br /><br /><a href="https://addon.dismall.com/?view=plugins" target="_top">Click here to return to the application center</a><br />',
	...
	'plugins_upgrade_succeed'		=> 'The plugin was successfully updated to {toversion}<br /><br /><a href="https://addon.dismall.com/?view=plugins" target="_top">Click here to return to the Application Center</a><br />',
	...
	'tpl_directory_invalid'			=> 'The template directory {directory} does not exist in the ./template/ folder or ends with "/"',
	...
	'threadtype_infotypes_optionvariable_invalid'	=> 'The category option variable name is duplicated or does not start with a letter',
	...
	'action_noaccess_config'		=> 'Sorry, the permissions required for this function are not configured in the site configuration file',
	...
	'cloudaddons_noaccess'			=> 'Only the website founder account can use <a href="https://addon.dismall.com/" target="_blank">Discuz! Application Center</a> to install plugins and templates. If you have any questions, please enter the Application Center to consult the application center customer service: <a href="https://addon.dismall.com/" target="_blank">https://addon.dismall.com/</a>',
	...
	'database_export_dos8p3_failed'		=> 'The server has enabled DOS 8.3 file name support. In order to avoid the risk of possible database blasting, online backup of the database is not allowed',
	...
	'database_export_succeed'		=> 'The data was successfully backed up to the server <a href="{filename}">{filename}</a><br /><br /><font color="red">For security reasons, We strongly recommend that you download the database backup file and delete the file or set the file to be inaccessible via URL.</font>{deletetips}',
	...
	'two_domain_have_been_occupied'	=> 'Sorry, this subdomain name has been occupied',//'抱歉，二级域名已被占用',
...
/*vot*/	'members_add_username_tooshort'		=> 'Sorry, the username you entered is less than 2 characters, please enter a longer username',
	...
	'members_ipban_nopermission'		=> 'Only administrators can use CIDR format to ban certain addresses',//'只有管理员可以使用CIDR格式禁止某段地址',
	'members_ipban_illegal'			=> 'Operation error! Please do not ban your own IP',//'操作错误！请不要禁止您自己的 IP',
	...
	'plugins_config_upgrade_missed'		=> 'This plugin has been updated to the latest version</h4><br /><a href="https://addon.dismall.com/?view=plugins" target="_top" class="lightlink">Click here to enter the Application Center</a><br /><br /><h4>',
	'plugins_config_upgrade_new'		=> 'This plugin has been updated to the latest version<br />But it is found that there is a new version {newver} of this plugin in the Application Center. Do you need to upgrade?</h4><br /><a href="{ADMINSCRIPT}?action=cloudaddons&id={addonid}&from=newver" target="_top" class="lightlink">Upgrade this plugin</a> &nbsp;&nbsp; <a href="{ADMINSCRIPT}?action=plugins" class="lightlink">Not to upgrade temporarily</a><h4>',
	...
	'styles_delete_invalid'			=> 'You cannot directly delete the template style in use, choose to use other template styles as the default and then delete this style',
	'styles_install_succeed'		=> 'The style installation is completed.<br /><br /><a href="https://addon.dismall.com?view=templates" target="_top">Click here to return to the Application Center</a><br />',
	...
	'cloudaddons_genuine_message'		=> 'Sorry, the application you are installing is not a genuine application, and the installer cannot continue<br /><br /><a href="{ADMINSCRIPT}?action=cloudaddons&id={addonid}" target="_top">Click here to install the genuine application</a>',
	...
	'optimizer_dos8p3_optimizer'	=> 'Please choose the correct technical route and solution according to your server environment, and turn off DOS 8.3 file name support through correct configuration in AdminCP',
	'optimizer_httphost_optimizer'	=> 'Please choose the correct technical route and solution according to your server environment, and close the empty HOST header support through the correct configuration in AdminCP',
	'optimizer_filesafe_optimizer'	=> 'I have tried to delete the installer, data recovery program and duplicate background entry files for you. If the detection is still abnormal, you need to check whether the relevant directory files exist, especially whether the old directory and the utility directory are deleted',
	'optimizer_remote_optimizer'	=> 'This function is not activated by you, please disable the remote calling function and modify the remote key in config_global.php',
);

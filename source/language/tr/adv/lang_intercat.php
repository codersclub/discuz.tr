 ...
 *
 *      $Id: lang_intercat.php by Valery Votintsev, codersclub.org
 */
...
(
	...
	'intercat_desc'			=> 'Display Adv between two forums in a category. In general, it is 960x60 images or Flash. If there are multipe category advs, they will be displayed in random.',//'展现方式: 论坛分类间广告显示于版块列表相邻的两个版块分类之间，可使用 960x60 或其他尺寸图片和 Flash 的形式。当前页面有多个分类间广告时，系统会从中抽取与版块分类数相等的条目进行随机显示。<br />价值分析:由于出现在版块列表页比较明显的位置，广告展示效果较好，但是过多过大的广告可能会招致访问者反感。 ',

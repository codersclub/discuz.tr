 ...
 *
 *      $Id: lang_interthread.php by Valery Votintsev, codersclub.org
 */
...
(
	...
	'interthread_desc'		=> 'Display the Adv between first and second posts of a thread. In general, it is 960x60 or other size images and Flash.',//'展现方式: 帖间通栏广告显示于主题帖和第一个回帖之间，可使用 468x60 或其他尺寸图片和 Flash 的形式。<br />当前页面有多个帖间通栏广告时，系统会随机选取其中之一显示。价值分析: 由于能够将主题与回帖分开，广告尺寸大而且不影响帖子内容，因此不会招致帖子作者及访问者反感，适合在帖内进行商业宣传或品牌推广。',

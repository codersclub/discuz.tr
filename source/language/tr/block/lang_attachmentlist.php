 ...
 *
 *      $Id: lang_attachmentlist.php by Valery Votintsev, codersclub.org
 */
...
(
	...
	'attachmentlist_desc'			=> 'Show attachment list',//'论坛附件列表调用',
	'attachmentlist_fids'			=> 'Forums',//'所在版块',
	...
	'attachmentlist_items'			=> 'Rows',//'显示数据条数',
	...
	'attachmentlist_maxheight'		=> 'Max image height, px',//'图片最大高度(像素)',
	...
	'attachmentlist_threadmethod'		=> 'Thread attach method',//'主题方式调用',

...
please ignore and delete this message. In the case you confirm the password reset,
...
<p>After the above page open, enter a new password and submit a form, after then you can use your new password. You can change your password at any time in a user control panel.</p>
...
If you do not want to access to {bbname}, or you did not registered at this site, please ignore this message.

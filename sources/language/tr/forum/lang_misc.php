...
//vot	'post_trade_transport_mail'	=> 'Mail',
	...
	'perms_allowpostimage'		=> 'Resim yükle',//'上传图片',
...
//vot	'perms_allowbioimgcode'		=> '[img] Profil',
	...
	'connectguest_message_replace'	=> array('Bilgilerinizi <a href="member.php?mod=connect">geliştirin</a> veya <a href="member.php?mod=connect&ac=bind">hesabı ile bağlanın</a>', 've <a href="member.php?mod=connect">bilgi geliştirin</a> »ò <a href="member.php?mod=connect&ac=bind">hesabı ile bağlanın</a>'),
	...
	'plugin_title'		=> 'Güncelleme Var',
	'plugin_memo'		=> ' <span class="xi1">{number}</span> adet uygulama için güncelleme var',
	'plugin_link'		=> 'Şimdi güncelleştir',

	'seccode'		=> 'Onay Kodu',//'验证码',
	'seccode_update'	=> 'Yenile',//'换一个',
	'seccode_player'	=> '<span style="padding:2px"><img border="0" style="vertical-align:middle" src="static/image/common/seccodeplayer.gif" /> <a href="javascript:;" id="seccodeplay_{idhash}">Doğrulama kodunu oynatın</a></span>',
	'secqaa'		=> 'Güvenlik Cevabı',//'验证问答',

	'mobileoem_creditrule'	=> 'Mobil Forum Kaydı',//'掌上论坛签到',

...
(
	...
	'gift_bad_credittype_input'	=> 'Specified type of points is wrong',//'指定的积分类型有误',
	'gift_credits_out_of_own'	=> 'Number of gift points is more than you have',//'输入的积分数超出您拥有的积分数',
	'gift_gc'			=> 'Return the Red Envelope',//'回收红包',
	'gift_use'			=> 'Use the red envelope',//'埋个红包',

	'gift_receive_gift'		=> 'Get {percredit} red envelope of {credittype}',//'领取红包 {percredit} {credittype}',
);
